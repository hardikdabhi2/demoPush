...
//
//  Created by Merry on 22/09/17.
//  Copyright © 2017 Innopad Solutions LLP. All rights reserved.
//
...
class HDView: UIView {
    ...
    @IBInspectable
    open var maskCorner:CACornerMask {
        get {
            if #available(iOS 11.0, *) {
                return layer.maskedCorners
            } else {
                return CACornerMask(rawValue: 0)
